...
# ├── member1\_setup.sh     # Apache + SSL + Modules

# ├── member2\_setup.sh     # Auto VirtualHost + Document Root Setup

# ├── member3\_setup.sh     # Security, Firewall, SSH Hardening

# ├── member4\_setup.sh     # Monitoring + Auto-Recovery

# ├── member5\_setup.sh     # Backup, Rotation, Restore Script
...
# ~/webserver\_lab/backups/<sitename>/
...
# bash ~/webserver\_lab/backups/<sitename>/restore.sh
